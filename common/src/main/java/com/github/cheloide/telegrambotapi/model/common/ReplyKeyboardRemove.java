 ...
 * @see <a href="https://core.telegram.org/bots/api#replykeyboardremove">https://core.telegram.org/bots/api#replykeyboardremove</a>
 * 
 */
public class ReplyKeyboardRemove {
     ...
     * accessible, use one_time_keyboard in {@link ReplyKeyboardMarkup})
     */
    @JsonProperty("remove_keyboard")
    private Boolean removeKeyboard;
    /**
     * Optional. Use this parameter if you want to remove the keyboard for specific
     * users only. Targets: 1) users that are @mentioned in the text of the {@link Message}
