 ...
 * modern day polish. Guide the user through a step-by-step process. ‘Please
 * send me your question’, ‘Cool, now let’s add the first answer option‘,
...
public class ForceReply {
    ...
    private Boolean forceUserReply;
    /**
     ...
     */
    public Boolean getForceUserReply() {
        return forceUserReply;
    }
     ...
     */
    public void setForceUserReply(Boolean forceUserReply) {
        this.forceUserReply = forceUserReply;
    }
